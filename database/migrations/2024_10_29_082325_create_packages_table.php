...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('packages')->insert([
            ...
            ['service_id' => 3, 'type' => 'Live-out', 'title' => 'Monthly Packages', 'duty_time' => '7am-5pm or 8am-6pm', 'working_days' => '6 days/week', 'meals_provided' => 'One time meal needs to be provided', 'transportation' => "Rate are inclusive of transportation fees.", 'created_at' => now(), 'updated_at' => now()],
            ['service_id' => 3, 'type' => 'Live-in', 'title' => 'Monthly Packages', 'duty_time' => 'Flexible', 'working_days' => '6 days/week', 'meals_provided' => 'Three time meal needs to be provided', 'transportation' => "Duty-off hours need to be provided ( E.g, off-duty when the patient sleeps & after the patient has gone to bed)", 'created_at' => now(), 'updated_at' => now()],
