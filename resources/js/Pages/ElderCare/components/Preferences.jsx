...
import CaregiverStand from "@/Components/Fancy/CaregiverStand";
        ...
        >
            <Box textAlign="center">
                <Box display={"inline-block"} position={"relative"}>
                    <MainTitle>Caregiver Preferences</MainTitle>
                    <Box
                        sx={{
            ...
            {/* right noodle  */}
            <Noodle bottom={0} right={-10} />

            {/* left noodle  */}
            <Noodle top={0} left={-10} />

            <CaregiverStand bottom={0} left={-20} />
        </Box>
    );
}
