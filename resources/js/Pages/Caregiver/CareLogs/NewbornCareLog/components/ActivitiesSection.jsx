                        ...
                        <Grid2 container spacing={2} sx={{ mb: 3 }}>
                            ...
                            <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
                                <FormControl fullWidth variant="standard">
                                    ...
                                    <Select
                                        ...
                                        label="Activity"
                                    >
                                        <MenuItem value="Tummy Time">
                                            Tummy Time
                                        </MenuItem>
                                        <MenuItem value="Walk">Walk</MenuItem>
                                        <MenuItem value="Play">Play</MenuItem>
                                        <MenuItem value="Massage">
                                            Massage
                                        </MenuItem>
                                        <MenuItem value="Reading">
                                            Reading
                                        </MenuItem>
                                        <MenuItem value="Singing">
                                            Singing
                                        </MenuItem>
                            ...
                            <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
                                <TextField
                                    fullWidth
                                    variant="standard"
                                    label="Notes" // Changed from "Describe details" to "Notes"
                                    value={item.details}
                                    onChange={(e) =>
                                        handleArrayChange(
                                            "activities",
                                    ...
                                    multiline
                                    maxRows={3}
                                    placeholder="Activity notes..." // Changed from "Activity details..."
                                />
                            </Grid2>
                        </Grid2>
