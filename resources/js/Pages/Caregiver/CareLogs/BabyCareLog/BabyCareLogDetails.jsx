                    ...
                    <Button
                        ...
                        sx={{
                            background: isGeneratingPDF
                                ? "linear-gradient(45deg, #9e9e9e 30%, #919090ff 90%)"
                                : "linear-gradient(45deg, #3571a2ff 30%, #298cddff 90%)",
                            "&:hover": {
                                background: isGeneratingPDF
...
export default BabyCareLogDetails;
