...
import ToiletIcon from "@mui/icons-material/WcOutlined";
import "../../../../../css/a4.css";
...
const ShowBabyCareLogDetails = () => {
    ...
    const foodOfferedRows = (food_offered_records || []).map((item) => [
        item.meal_time || "-",
        item.food_offered || "-",
        item.quantity || "-",
        item.texture || "-",
    ...
    const toiletingRows = (toileting_training_records || []).map((item) => [
    ...
    return (
        <div className="a4-page">
            ...
            {/* Basic Info */}
            <SectionTitle>Baby Information</SectionTitle>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 2, mt: 3 }}>
                <Avatar sx={{ bgcolor: "#fff9c4", color: "#f57f17" }}>
                    <FoodIcon />
                </Avatar>
                <SectionTitle fontSize={18}>Food Offered</SectionTitle>
            </Box>
            <TableSection
                columns={[
                    "Meal Time",
                ...
                rows={foodOfferedRows}
                emptyMessage="No food offered records found"
            />
            ...
            <TableSection
                ...
                rows={toiletingRows}
                emptyMessage="No toileting training records found"
            />
...
export default ShowBabyCareLogDetails;
