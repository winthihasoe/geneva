...
const sections = [
    { title: "Newborn Care", link: "#" },
    { title: "Maternal Care", link: "#" },
    { title: "Baby Milestones", link: "#" },
...
function MaternalAndBabyHealth() {
    return (
        <AppLayout>
            <Container maxWidth="lg" sx={{ pt: { xs: 0, sm: 2, md: 3 } }}>
                <Typography
                    ...
                    textAlign={"center"}
                >
                    Maternal And Baby Health Care Tips
                </Typography>
                <Typography
                    variant="body1"
                    textAlign={"center"}
                    ...
                    mb={4}
                >
                    Essential care tips for mothers and babies, from pregnancy
                    to early childhood. Supportive, expert-backed guidance for a
...
export default MaternalAndBabyHealth;
