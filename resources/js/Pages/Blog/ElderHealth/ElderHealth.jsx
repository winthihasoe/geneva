...
const sections = [
    { title: "Basic Healthcare", link: "#" },
    { title: "Essential Nutrition", link: "#" },
    { title: "Hypertension  & Diabetes", link: "#" },
        ...
        <AppLayout>
            <Container maxWidth="xl" sx={{ pt: { xs: 0, sm: 2, md: 3 } }}>
                ...
                <Typography
                    ...
                    mb={4}
                >
                    Essential tips and advice for maintaining health and
                    wellness in older adults, covering nutrition, exercise,
                    ...
                    {sections.length > 0 &&
                        sections.map((section, index) => (
                            <Button
                                ...
                                onClick={() =>
                                    router.get(
                                        route("blog.elder.healthcare.section", {
